...
if ENCODER_NAME.__contains__('SBert') :
    EMBEDDING_SIZE = 384
elif ENCODER_NAME.__contains__('bert-base-mean-cls') :
    EMBEDDING_SIZE = 768
elif ENCODER_NAME.__contains__('bert-large-mean-cls') :
    EMBEDDING_SIZE = 1024
elif ENCODER_NAME.__contains__('roberta-base-mean-cls') :
    EMBEDDING_SIZE = 768
elif ENCODER_NAME.__contains__('roberta-large-mean-cls') :
    EMBEDDING_SIZE = 1024
...
"""
valid_data_file = 'CORPUS/analogies/analogies_snli_valid_40k.csv'
test_data_file = 'CORPUS/analogies/analogies_snli_test_40k.csv'
train_data_file = 'CORPUS/analogies/analogies_snli_train_400k.csv'
"""
