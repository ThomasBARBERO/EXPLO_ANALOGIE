...
"""
valid_data_file = 'CORPUS/analogies/analogies_paraphrases_valid_40k.csv'
test_data_file = 'CORPUS/analogies/analogies_paraphrases_test_40k.csv'
train_data_file = 'CORPUS/analogies/analogies_paraphrases_train_400k.csv'
"""
...
"""
training_set = AnalogiesData(train_data_file, 'CORPUS/ENCODED/encoded_phrases_'+ENCODER_NAME+'.pt')
valid_set = AnalogiesData(valid_data_file, 'CORPUS/ENCODED/encoded_phrases_'+ENCODER_NAME+'.pt')
testing_set = AnalogiesData(test_data_file, 'CORPUS/ENCODED/encoded_phrases_'+ENCODER_NAME+'.pt')
